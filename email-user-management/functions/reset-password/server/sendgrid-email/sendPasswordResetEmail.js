...
module.exports = (event) => {
  ...
  const fromEmail = new helper.Email('me@mywebsite.com', 'Joe Shmoe')
...
<body>
  <p>Hi -firstname-,</p>
  <p><a href="https://mywebsite.com/reset?token=${resetToken}&email=${email}">Click here to reset your password.</a></p>
</body>
</html>`
