...
They do however already contain the code that's necessary to get the provided functionality into your project. You might need to do a bit more manual work to actually get them up-and-running.
