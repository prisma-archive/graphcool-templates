...
The function in [`githubAuthentication.js`](./src/githubAuthentication.js) needs access to a [root token](https://docs-next.graph.cool/reference/auth/authentication/authentication-tokens-eip7ahqu5o#root-tokens). 
